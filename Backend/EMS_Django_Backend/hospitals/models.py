...
class Hospital(models.Model):
    ...
    phone = models.CharField(verbose_name='phone number', max_length=10, null=False, unique=True, validators=[RegexValidator(
            regex='^[0-9]*$',
            message='The phone number must only contain numbers in the format 01234567890',
            code='invalid_phone_number'
        )])
    rch = models.CharField(null=False, max_length=100)
